!
! Solving deadlock issue with reversing the order of send/receive 
!
program deadlock_order
  use mpi_f08
  implicit none
  ...
  if (myRank .eq. 0) then
    ...
    call MPI_Send(a, 5, MPI_INTEGER, 1, 100, MPI_COMM_WORLD, ierror)
